...
if("TRUE" STREQUAL "TRUE")
  set(pathfinder_SOURCE_PREFIX /home/ece446/mal/FinalRelease/src/pathfinder)
  set(pathfinder_DEVEL_PREFIX /home/ece446/mal/FinalRelease/devel)
  ...
  set(pathfinder_INSTALL_PREFIX /home/ece446/mal/FinalRelease/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'pathfinder' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'ece446 <ece446@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'pathfinder' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ece446/mal/FinalRelease/src/pathfinder/${idir}'.  Ask the maintainer 'ece446 <ece446@todo.todo>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${pathfinder_dep}_FOUND)
      find_package(${pathfinder_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${pathfinder_dep} REQUIRED ${depend_list})
  endif()
